  ...
  return (
    <div className="page-gradient">
      ...
      <section className="max-w-7xl mx-auto px-4 mt-10 animate-fade-in">
        <h2 className="text-2xl font-bold text-slate-900">All Specialties</h2>
        <div className="mt-4 flex flex-wrap gap-3">
          {specs.map((name) => (
            <span key={name} className="px-3 py-1 rounded-xl bg-white/80 border border-white/40 shadow-sm text-slate-800 text-sm hover:bg-blue-50 hover:border-blue-200 transition">
              {name}
            </span>
          ))}
        </div>
